...
class CommentController extends Controller
{
    ...
    public function approved(Comment $comment)
    {
        ...
        if ($result){
            ...
            return redirect()->route('admin.market.comment.index')->with('swal-success', 'وضعیت نظر شما با موفقیت تغییر کرد');

        }
        else {

            return redirect()->route('admin.market.comment.index')->with('swal-error', 'وضعیت نظر شما با خطا مواجه شد');
    ...
    public function answer(CommentRequest $request, Comment $comment)
    {
        if ($comment->parent == null)
        {
            ...
            return redirect()->route('admin.market.comment.index')->with('swal-success', 'پاسخ جدید شما با موفقیت ثبت شد');
