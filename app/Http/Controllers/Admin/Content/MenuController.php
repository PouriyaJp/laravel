...
class MenuController extends Controller
{
    ...
    public function update(MenuRequest $request, Menu $menu)
    {
        $inputs = $request->all();
        $menu->update($inputs);
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منو جدید شما با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'فهرست شما با موفقیت حذف شد');
    }
