    ...
    <section class="row">
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="table-responsive font-size-12">
                    <table class="table table-striped table-hover font-size-12">
                        ...
                        <tr>
                            ...
                            <td>تایید شده</td>
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.content.comment.show') }}" class="btn btn-info btn-sm font-size-12"><i class="fa fa-eye"></i> نمایش</a>
                                <button class="btn btn-warning btn-sm" type="submit"><i class="fa fa-clock font-size-12"></i> عدم تایید</button>
                            </td>
                        </tr>
                        </tbody>
                    </table>
