    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.content.post.create') }}" class="btn btn-info btn-sm font-size-12">ایجاد پست </a>
                ...
                <table class="table table-striped table-hover font-size-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
{{--                                <img src="{{ asset($post->image['indexArray'][$post->image['currentImage']]) }}" alt="" style="width: 40px;height: 40px;">--}}
                            </td>
