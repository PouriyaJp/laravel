    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="" class="btn btn-info btn-sm disabled font-size-12">ایجاد تنظیمات جدید</a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-22-rem text-left">
                                ...
                                <button disabled class="btn btn-danger btn-sm font-size-12" type="submit"><i class="fa fa-trash-alt"></i> حذف</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
