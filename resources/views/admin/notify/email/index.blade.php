    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                <a href="{{ route('admin.notify.email.create') }}" class="btn btn-info btn-sm font-size-12">ایجاد اطلاعیه ایمیلی</a>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="#" class="btn btn-info btn-sm font-size-12"><i class="fa fa-edit"></i> ویرایش</a>
