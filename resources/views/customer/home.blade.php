...
@section('content')
    ...
    <section class="mb-3">
        <section class="container-xxl">
            ...
            <section class="row py-4">
                <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100" src="{{ asset('customer-assets/images/ads/two-col-1.jpg') }}" alt=""></section>
                <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100" src="{{ asset('customer-assets/images/ads/two-col-2.jpg') }}" alt=""></section>
            </section>
                                ...
                                <section class="item">
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="" src="{{ asset('customer-assets/images/products/7.jpg') }}" alt="">
                                                </section>
                                                <section class="product-colors"></section>
                                ...
                                <section class="item">
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="" src="{{ asset('customer-assets/images/products/8.jpg') }}" alt="">
                                                </section>
                                                <section class="product-colors"></section>
                                ...
                                <section class="item">
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="" src="{{ asset('customer-assets/images/products/9.jpg') }}" alt="">
                                                </section>
                                                <section class="product-colors"></section>
                                ...
                                <section class="item">
                                    <section class="lazyload-item-wrapper">
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="" src="{{ asset('customer-assets/images/products/12.jpg') }}" alt="">
                                                </section>
                                                <section class="product-colors"></section>
    ...
    <section class="mb-3">
        <section class="container-xxl">
            <!-- one column -->
            <section class="row py-4">
                <section class="col"><img class="d-block rounded-2 w-100" src="{{ asset('customer-assets/images/ads/one-col-1.jpg') }}" alt=""></section>
            </section>
                        ...
                        <section class="brands dark-owl-nav owl-carousel owl-theme">
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/huawei.jpg') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/adata.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/casio.jpg') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/gplus.jpg') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/logitech.jpg') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/nokia.jpg') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/pakshoma.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/panasonic.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/parskhazar.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/samsung.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/snowa.png') }}" alt=""></a>
                                </section>
                            </section>
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2" src="{{ asset('customer-assets/images/brand/xvision.png') }}" alt=""></a>
                                </section>
                            </section>
                        </section>
                    </section>
